<template>
  <div
    ...
    <div class="relative"
      ...
      <image-card :height="height" :width="width" :position="position" :image="image"/>
    </div>
    <time-list :list="list" :title="title" :title-position="titlePosition"/>
  </div>
</template>
<script>
...
export default {
  name: 'ProgramCard',
  props: ['type', 'image', 'position', 'height', 'width', 'list', 'title', 'titlePosition']
}
</script>